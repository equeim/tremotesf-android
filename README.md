...
## Build
1. Download and install Android Studio 3.3. Download and install Android NDK (r16b or newer).
...
3. [Download](http://download.qt.io/official_releases/qt/5.12/5.12.1/submodules/qtbase-everywhere-src-5.12.1.tar.xz) Qt base submodule (5.11 or newer) and unpack it to 3rdparty/qt/qtbase.
