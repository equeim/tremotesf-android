...
## Build
1. Download and install Android Studio 3.5. Download and install Android NDK (r19c or newer).
...
3. [Download](http://download.qt.io/official_releases/qt/) Qt's qtbase submodule (5.12 or newer, 5.14 is not supported yet) and unpack it to 3rdparty/qt/qtbase.
