...
import org.equeim.tremotesf.torrentfile.rpc.requests.MinutesSinceStartOfDaySerializer
...
suspend fun RpcClient.setAlternativeLimitsBeginTime(value: LocalTime) =
    setSessionProperty("alt-speed-time-begin", value, MinutesSinceStartOfDaySerializer)
