...
public class libtremotesfJNI {
  public final static native long new_TorrentsVector__SWIG_0();
  public final static native long new_TorrentsVector__SWIG_1(long jarg1, TorrentsVector jarg1_);
  ...
  public final static native long new_TorrentsVector__SWIG_2(int jarg1, long jarg2, Torrent jarg2_);
  public final static native int TorrentsVector_doSize(long jarg1, TorrentsVector jarg1_);
  public final static native void TorrentsVector_doAdd__SWIG_0(long jarg1, TorrentsVector jarg1_, long jarg2, Torrent jarg2_);
  public final static native void TorrentsVector_doAdd__SWIG_1(long jarg1, TorrentsVector jarg1_, int jarg2, long jarg3, Torrent jarg3_);
  public final static native long TorrentsVector_doRemove(long jarg1, TorrentsVector jarg1_, int jarg2);
  public final static native long TorrentsVector_doGet(long jarg1, TorrentsVector jarg1_, int jarg2);
  ...
  public final static native long Rpc_serverSettings(long jarg1, Rpc jarg1_);
  public final static native long Rpc_serverStats(long jarg1, Rpc jarg1_);
  public final static native long Rpc_torrents(long jarg1, Rpc jarg1_);
  public final static native long Rpc_torrentByHash(long jarg1, Rpc jarg1_, String jarg2);
  public final static native long Rpc_torrentById(long jarg1, Rpc jarg1_, int jarg2);
  public final static native boolean Rpc_isConnected(long jarg1, Rpc jarg1_);
  public final static native int Rpc_status(long jarg1, Rpc jarg1_);
  public final static native int Rpc_error(long jarg1, Rpc jarg1_);
  public final static native String Rpc_errorMessage(long jarg1, Rpc jarg1_);
  public final static native boolean Rpc_isLocal(long jarg1, Rpc jarg1_);
  public final static native int Rpc_torrentsCount(long jarg1, Rpc jarg1_);
  public final static native boolean Rpc_backgroundUpdate(long jarg1, Rpc jarg1_);
  public final static native void Rpc_setBackgroundUpdate(long jarg1, Rpc jarg1_, boolean jarg2);
  public final static native boolean Rpc_isUpdateDisabled(long jarg1, Rpc jarg1_);
  public final static native void Rpc_setUpdateDisabled(long jarg1, Rpc jarg1_, boolean jarg2);
  public final static native void Rpc_resetServer(long jarg1, Rpc jarg1_);
  public final static native void Rpc_connect(long jarg1, Rpc jarg1_);
  public final static native void Rpc_disconnect(long jarg1, Rpc jarg1_);
  public final static native void Rpc_addTorrentFile(long jarg1, Rpc jarg1_, byte[] jarg2, String jarg3, int[] jarg4, int[] jarg5, int[] jarg6, int[] jarg7, int[] jarg8, int jarg9, boolean jarg10);
  public final static native void Rpc_addTorrentLink(long jarg1, Rpc jarg1_, String jarg2, String jarg3, int jarg4, boolean jarg5);
  public final static native void Rpc_startTorrents(long jarg1, Rpc jarg1_, int[] jarg2);
  public final static native void Rpc_startTorrentsNow(long jarg1, Rpc jarg1_, int[] jarg2);
  public final static native void Rpc_pauseTorrents(long jarg1, Rpc jarg1_, int[] jarg2);
  public final static native void Rpc_removeTorrents(long jarg1, Rpc jarg1_, int[] jarg2, boolean jarg3);
  public final static native void Rpc_checkTorrents(long jarg1, Rpc jarg1_, int[] jarg2);
  public final static native void Rpc_moveTorrentsToTop(long jarg1, Rpc jarg1_, int[] jarg2);
  public final static native void Rpc_moveTorrentsUp(long jarg1, Rpc jarg1_, int[] jarg2);
  public final static native void Rpc_moveTorrentsDown(long jarg1, Rpc jarg1_, int[] jarg2);
  public final static native void Rpc_moveTorrentsToBottom(long jarg1, Rpc jarg1_, int[] jarg2);
  public final static native void Rpc_reannounceTorrents(long jarg1, Rpc jarg1_, int[] jarg2);
  public final static native void Rpc_setTorrentsLocation(long jarg1, Rpc jarg1_, int[] jarg2, String jarg3, boolean jarg4);
  public final static native void Rpc_getTorrentFiles(long jarg1, Rpc jarg1_, int jarg2, boolean jarg3);
  public final static native void Rpc_getTorrentPeers(long jarg1, Rpc jarg1_, int jarg2, boolean jarg3);
