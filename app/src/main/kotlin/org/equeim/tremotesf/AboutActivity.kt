...
class AboutActivity : BaseActivity(R.layout.about_activity, true) {
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        supportFragmentManager.findFragmentById(R.id.about_fragment)?.onActivityResult(requestCode, resultCode, data)
...
class AboutFragment : Fragment(R.layout.about_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (requireActivity().intent.getBooleanExtra("donate", false)) {
            pager.currentItem = 1
        }
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        (requireActivity() as AppCompatActivity).apply {
            setSupportActionBar(this@AboutFragment.toolbar as Toolbar)
    ...
    private inner class PagerAdapter : FragmentPagerAdapter(requireFragmentManager(), BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
