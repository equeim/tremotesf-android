...
@Parcelize
data object ConnectionSettingsDestination : Destination {
    @Composable
    override fun Content(navController: NavController) {
        ...
        ConnectionSettingsScreen(
            ...
            editServer = { navController.navigateTo(ServerEditDestination(it)) },
            removeServers = model::removeServers,
            addServer = { navController.navigateTo(ServerEditDestination()) }
        )
    }
}
