...
@Parcelize
data object ServerSettingsNetworkDestination : Destination {
    @Composable
    override fun Content(navController: NavController) {
        val model = viewModel<NetworkScreenViewModel>()
...
class NetworkScreenViewModel(application: Application) : AndroidViewModel(application) {
