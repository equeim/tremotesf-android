...
package org.equeim.tremotesf.ui.torrentproperties
...
@Parcelize
data class TorrentPropertiesDestination(val torrentHashString: String) : Destination {
    @Composable
    override fun Content(navController: NavController) {
        val model = viewModel {
            TorrentPropertiesScreenViewModel(
        ...
        TorrentPropertiesScreen(
            ...
            navigateToLabelsEditDialog = { enabledLabels ->
                navController.navigateTo(
                    LabelsEditDialogDestination(
                        torrentHashStrings = listOf(torrentHashString),
            ...
            navigateToSetLocationDialog = { location ->
                navController.navigateTo(
                    TorrentsSetLocationDialogDestination(
                        torrentHashStrings = listOf(torrentHashString),
                        location = location
                    )
                )
...
private fun TorrentPropertiesScreen(
    ...
    filesTreeState: StateFlow<TorrentPropertiesScreenViewModel.FilesTreeState>,

    trackers: StateFlow<RpcRequestState<List<TorrentPropertiesScreenViewModel.TrackerItem>>>,
