...
@Parcelize
data object ServerSettingsSpeedDestination : Destination {
    @Composable
    override fun Content(navController: NavController) {
        val model = viewModel<SpeedScreenViewModel>()
...
class SpeedScreenViewModel(application: Application) : AndroidViewModel(application) {
