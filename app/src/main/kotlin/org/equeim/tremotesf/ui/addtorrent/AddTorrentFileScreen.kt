...
@Parcelize
data class AddTorrentFileDestination(val uri: android.net.Uri) : Destination {
    @Composable
    override fun Content(navController: NavController) {
        ...
        AddTorrentFileScreen(
            navigateUp = { navController.popBackStackOrStartNewTask(activity) },
        ...
        HandleFinishedAddTorrentState(
            state = model.addTorrentState,
