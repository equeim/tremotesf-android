...
import org.equeim.tremotesf.ui.AboutDestination
import org.equeim.tremotesf.ui.Destination
import org.equeim.tremotesf.ui.Dimens
import org.equeim.tremotesf.ui.LabelsEditDialogDestination
import org.equeim.tremotesf.ui.NavController
import org.equeim.tremotesf.ui.SettingsDestination
import org.equeim.tremotesf.ui.ShowRpcErrorsSnackbar
import org.equeim.tremotesf.ui.TorrentsSetLocationDialogDestination
...
import org.equeim.tremotesf.ui.connectionsettings.ConnectionSettingsDestination
import org.equeim.tremotesf.ui.connectionsettings.ServerEditDestination
import org.equeim.tremotesf.ui.serversettings.ServerSettingsDestination
import org.equeim.tremotesf.ui.torrentproperties.TorrentPropertiesDestination
import org.equeim.tremotesf.ui.torrentslist.TorrentsListScreenViewModel.FloatingActionButtonState
import org.equeim.tremotesf.ui.utils.Utils
import org.equeim.tremotesf.ui.utils.rememberFileSizeFormatter

@Parcelize
data object TorrentsListDestination : Destination {
    @Composable
    override fun Content(navController: NavController) {
        val model = viewModel<TorrentsListScreenViewModel>()
        ...
        TorrentsListScreen(
            ...
            navigateToSettings = { navController.navigateTo(SettingsDestination) },
            navigateToAboutScreen = { navController.navigateTo(AboutDestination) },
            shutdownApp = { Utils.shutdownApp(context) },
            navigateToServerAddingScreen = { navController.navigateTo(ServerEditDestination()) },
            navigateToAddTorrentFileScreen = { navController.navigateTo(AddTorrentFileDestination(it)) },
            navigateToAddTorrentLinkScreen = {
                navController.navigateTo(AddTorrentLinkDestination())
            },
            navigateToTorrentPropertiesScreen = { navController.navigateTo(TorrentPropertiesDestination(it)) },
            navigateToConnectionSettingsScreen = { navController.navigateTo(ConnectionSettingsDestination) },
            navigateToServerSettingsScreen = { navController.navigateTo(ServerSettingsDestination) },
            navigateToServerStatsDialog = { navController.navigateTo(ServerStatsDialogDestination) },
            navigateToSetLocationDialog = { torrentHashStrings, location ->
                navController.navigateTo(
                    TorrentsSetLocationDialogDestination(torrentHashStrings, location)
                )
            },
            navigateToLabelsEditDialog = { torrentHashStrings, enabledLabels ->
                navController.navigateTo(
                    LabelsEditDialogDestination(torrentHashStrings, enabledLabels)
                )
            },
...
private fun TorrentsListScreen(
    title: State<TorrentsListScreenViewModel.TitleState?>,
    subtitle: State<TorrentsListScreenViewModel.SubtitleState?>,
    ...
    sortAndFilterSettings: State<TorrentsListScreenViewModel.SortAndFilterSettings?>,
    ...
    listSettings: State<TorrentsListScreenViewModel.ListSettings?>,
