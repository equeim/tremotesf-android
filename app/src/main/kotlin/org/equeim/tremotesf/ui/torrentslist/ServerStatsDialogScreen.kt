...
@Parcelize
data object ServerStatsDialogDestination : Destination {
    @Composable
    override fun Content(navController: NavController) {
        val model = viewModel<ServerStatsDialogScreenViewModel>()
...
private fun ServerStatsDialogContent(
    uiState: RpcRequestState<ServerStatsDialogScreenViewModel.UiState>,
    ...
    ServerStatsDialogContent(
        uiState = remember {
            RpcRequestState.Loaded(
                ServerStatsDialogScreenViewModel.UiState(
...
class ServerStatsDialogScreenViewModel : ViewModel() {
    data class UiState(
