...
@Parcelize
data object ServerSettingsQueueDestination : Destination {
    @Composable
    override fun Content(navController: NavController) {
        val model = viewModel<QueueScreenViewModel>()
...
class QueueScreenViewModel(application: Application) : AndroidViewModel(application) {
