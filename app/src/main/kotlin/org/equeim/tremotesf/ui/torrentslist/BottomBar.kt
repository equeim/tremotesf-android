...
fun BottomBar(
    ...
    floatingActionButtonState: State<TorrentsListScreenViewModel.FloatingActionButtonState>,
...
private fun Buttons(
    ...
    Row(
        ...
        Box(
            ...
            if (fabState == TorrentsListScreenViewModel.FloatingActionButtonState.AddTorrent) {
                ...
                ExtendedFloatingActionButton(
                    ...
                    onClick = {
                        when (fabState) {
                            TorrentsListScreenViewModel.FloatingActionButtonState.Connect ->
                                setShouldConnectToServer(true)

                            TorrentsListScreenViewModel.FloatingActionButtonState.Disconnect ->
                                setShouldConnectToServer(false)

                            TorrentsListScreenViewModel.FloatingActionButtonState.AddServer ->
                                navigateToServerAddingScreen()

                            // Impossible case
                            TorrentsListScreenViewModel.FloatingActionButtonState.AddTorrent ->
                    ...
                    Text(
                        stringResource(
                            when (fabState) {
                                TorrentsListScreenViewModel.FloatingActionButtonState.Connect -> R.string.connect
                                TorrentsListScreenViewModel.FloatingActionButtonState.Disconnect -> R.string.disconnect
                                TorrentsListScreenViewModel.FloatingActionButtonState.AddServer -> R.string.add_server
                                // Impossible case
                                TorrentsListScreenViewModel.FloatingActionButtonState.AddTorrent -> throw IllegalStateException()
                            }
                        )
                    )
                }
