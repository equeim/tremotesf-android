...
fun FilesTab(
    ...
    when (val state = filesTreeState.value) {
        is TorrentPropertiesScreenViewModel.FilesTreeState.Loading -> TremotesfLoadingPlaceholder(
            modifier = Modifier
                .fillMaxSize()
        ...
        is TorrentPropertiesScreenViewModel.FilesTreeState.Error -> TremotesfErrorPlaceholder(
            error = state.error,
        ...
        is TorrentPropertiesScreenViewModel.FilesTreeState.Loaded -> {
